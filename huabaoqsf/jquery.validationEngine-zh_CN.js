    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				"ajaxUserCallPhp": {
                    "url": "http://www.huabaoqsf.com/js/posabsolute-jQuery-Validation-Engine-2c29415/js/languages/phpajax/ajaxValidateFieldUser.php",
                    // you may want to pass extra data on the ajax call
                    "extraData": "name=eric",
                ...
                "ajaxNameCall": {
				 ...
				 "ajaxNameCallPhp": {
	                    // remote json service location
	                    "url": "http://www.huabaoqsf.com/js/posabsolute-jQuery-Validation-Engine-2c29415/js/languages/phpajax/ajaxValidateFieldName.php",
	                    // error
	                    "alertText": "* 此名称已被其他人使用",
	                    // speaks by itself
	                    "alertTextLoad": "* 正在确认名称是否有其他人使用，请稍等。"

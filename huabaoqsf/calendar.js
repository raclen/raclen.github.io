...
//	(this.weekNumbers) && ++title_length;
	...
	this._nav_py = hh("<img id=objyprev src=\"yprev.gif\"/*tpa=http://www.huabaoqsf.com/js/calendar/images/yprev.gif*/>", 1, -2);
...
//	this._nav_py = hh("&#x00ab;", 1, -2);
	...
	//	this._nav_ny = hh("&#x00bb;", 1, 2);
	this._nav_ny = hh("<img id=objynext src=\"ynext.gif\"/*tpa=http://www.huabaoqsf.com/js/calendar/images/ynext.gif*/>", 1, 2);
	this._nav_ny.width = 25;
	this._nav_ny.ttip = Calendar._TT["NEXT_YEAR"];

//	this._nav_pm = hh("&#x2039;", 1, -1);
	this._nav_pm = hh("<img id=objmprev src=\"mprev.gif\"/*tpa=http://www.huabaoqsf.com/js/calendar/images/mprev.gif*/>", 1, -1);
...
//	this._nav_nm = hh("&#x203a;", 1, 1);
	this._nav_nm = hh("<img id=objmnext src=\"mnext.gif\"/*tpa=http://www.huabaoqsf.com/js/calendar/images/mnext.gif*/>", 1, 1);
...
//	this._nav_now.ttip = Calendar._TT["GO_TODAY"];
	...
	if (this.isPopup) {
		...
		var td_close = hh("<img id=objclose src=\"close.gif\"/*tpa=http://www.huabaoqsf.com/js/calendar/images/close.gif*/>", 1, 200);
		td_close.ttip = Calendar._TT["CLOSE"];
		td_close.align = "right";
		//hh("#<div><img src=\"close-1.gif\"/*tpa=http://www.huabaoqsf.com/include/calendar/images/calendar/close.gif*/ onmousedown=\"return;\"></div>", 1, 200).ttip = Calendar._TT["CLOSE"];
	}	
